...
<?php require_once("./includes/Header.php"); ?>
                ...
                <div class="space-y-8 -mt-12">
                    <form class="border border-slate-200 dark:border-slate-700 grid divide-x divide-slate-200 dark:divide-slate-700 lg:grid-cols-5 items-center bg-white dark:bg-transparent" action="" method="GET">
