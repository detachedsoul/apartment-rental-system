    ...
    <main class="grid place-content-center min-h-screen py-8 px-4 dark:bg-slate-900 dark:text-slate-400 lg:px-[30%]">
        <form class="bg-slate-100 py-8 px-4 rounded-xl lg:px-12 dark:bg-slate-800" method="POST">
            ...
            <div class="flex flex-col">
                ...
                <button
                    class="bg-sky-500 hover:bg-sky-600 focus:bg-sky-600 py-1.5 w-auto px-4 text-white rounded-lg lg:col-span-12 mt-4 dark:bg-sky-600 dark:hover:bg-sky-700 dark:focus:bg-sky-700"
                    type="submit"
                    name="submit"
                >
                    Reset Password
